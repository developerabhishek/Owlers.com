...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _monthAndDayTextColor       = [UIColor colorWithRed:252.0f/255 green:180.0f/255 blue:0.0f/255 alpha:1];
        _dayBgColorWithoutData      = [UIColor blackColor];
        _dayBgColorWithData         = [UIColor blackColor];
        _dayBgColorSelected         = [UIColor colorWithRed:252.0f/255 green:180.0f/255 blue:0.0f/255 alpha:1];
        
        
        _dayTxtColorWithoutData     = [UIColor whiteColor];;
        ...
        //NSArray * shortWeekdaySymbols = [[[NSDateFormatter alloc] init] sh];
        _weekDayNames  = @[@"M", @"T", @"W", @"T",@"F",@"S",@"S"];
...
//        button.layer.borderWidth = 1;
        ...
        button.layer.borderColor = [UIColor colorWithRed:252.0f/255 green:180.0f/255 blue:0.0f/255 alpha:1].CGColor;
    ...
    [_weekDayNames  enumerateObjectsUsingBlock:^(NSString * dayOfWeekString, NSUInteger idx, BOOL *stop)
     {
         ...
         weekNameLabel.backgroundColor   = [UIColor blackColor];
